                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <div class="stats p-3 w-100">
                                <?php if (isset($team['stats']) && isset($team['stats']['bans']['blue'])) { ?>
                                    <?php foreach (array_slice($team['stats']['bans']['blue'], 0, 10) as $stat) { ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <div class="stats p-3 w-100">
                                ...
                                <?php if (isset($team['stats']) && isset($team['stats']['bans_against']['blue'])) { ?>
                                    <?php foreach (array_slice($team['stats']['bans_against']['blue'], 0, 10) as $stat) { ?>
                                        <div class="d-flex align-items-center mb-1">
                                            <img src="<?= $stat['icon'] ?>" class="me-3" alt="<?= $stat['name'] ?>">
                                            <div>
                                                <p><?= $stat['name'] ?></p>
                        ...
                        <div class="col-6">
                            ...
                            <div class="stats p-3 w-100">
                                ...
                                <?php if (isset($team['stats']) && isset($team['stats']['bans_against']['red'])) { ?>
                                    <?php foreach (array_slice($team['stats']['bans_against']['red'], 0, 10) as $stat) { ?>
                                        <div class="d-flex align-items-center mb-1">
                                            <img src="<?= $stat['icon'] ?>" class="me-3" alt="<?= $stat['name'] ?>">
                                            <div>
                                                <p><?= $stat['name'] ?></p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <div class="stats w-100 p-3">
                                ...
                                <?php if (isset($team['stats']) && isset($team['stats']['picks']['blue'])) { ?>
                                    <?php foreach (array_slice($team['stats']['picks']['blue'], 0, 10) as $stat) { ?>
                                        <div class="d-flex align-items-center mb-1">
                                            <img src="<?= $stat['icon'] ?>" class="me-3" alt="<?= $stat['name'] ?>">
                                            <div>
                                                <p><?= $stat['name'] ?></p>
                        ...
                        <div class="col-6">
                            ...
                            <div class="stats w-100 p-3">
                                ...
                                <?php if (isset($team['stats']) && isset($team['stats']['picks']['red'])) { ?>
                                    <?php foreach (array_slice($team['stats']['picks']['red'], 0, 10) as $stat) { ?>
                                        <div class="d-flex align-items-center mb-1">
                                            <img src="<?= $stat['icon'] ?>" class="me-3" alt="<?= $stat['name'] ?>">
                                            <div>
                                                <p><?= $stat['name'] ?></p>
